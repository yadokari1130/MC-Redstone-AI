---
name: minecraft_block_summary
description: レッドストーン・ブロック・要約リファレンス
---
...
### 【重要】facing（向き）の定義
AIが混乱しやすいため、以下の定義を厳守してください。すべて **Minecraft 本来の仕様** に基づいています。

- **リピーター / コンパレーター / ピストン / ディスペンサー / ドロッパー / ホッパー**:
  - `facing` = **「出力側（前面・ヘッド・ノズル）」** が向いている方向。
  - 入力側はその真反対になります。
- **オブザーバー**:
  - `facing` = **「入力側（観察面・顔）」** が向いている方向。
  - 出力側はその真反対になります。
