...
## 操作 (Interaction)
- **mc_cli_interact_block**: 木製ドアの `open` 状態を反転させることができます。
- **鉄製・銅製ドア**: 右クリックによる操作はできません。レッドストーン信号による制御のみ可能です。
- **準接続 (QC) 非対応**: 鉄のドアなどは 2 マスの高さを持ちますが、ピストンと異なり **準接続（Quasi-connectivity）の影響は受けません。** 動作させるには直接、または隣接ブロックを介して動力を与える必要があります。
